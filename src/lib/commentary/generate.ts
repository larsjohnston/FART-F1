...
export async function generateCommentary(ctx: CommentaryContext): Promise<string | null> {
  ...
  try {
    ...
    const resp = await client.messages.create({
      ...
      system: systemPrompt(ctx.players, ctx.leagueName?.trim() || LEAGUE_NAME),
